...
export class LogExporter {
    client;
    indexPattern;
    constructor(client, indexPattern = 'platform-internal-logs-*') {
        this.client = client;
     ...
     */
    async fetchAllDocuments(query, maxDocuments) {
        const documents = [];
        ...
        try {
            ...
            while (hits.length > 0 && documents.length < maxDocuments) {
                ...
                if (hits.length > 0) {
                    ...
                    documents.push(...documentsToAdd.map((hit) => hit._source));
                }
            }
            return documents;
        }
     ...
     */
    createBundleMetadata(options, documents, exportId) {
     ...
     */
    async writeLogsToFile(documents, filePath) {
     ...
     */
    async writeReadmeFile(filePath, metadata) {
        const readme = `
...
For support, please include this entire bundle when reporting issues.
     ...
     */
    async createCompressedBundle(tempDir, exportId) {
     ...
     */
    extractUniqueServices(documents) {
     ...
     */
    extractUniqueLogLevels(documents) {
