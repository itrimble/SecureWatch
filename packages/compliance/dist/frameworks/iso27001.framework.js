...
exports.ISO27001Framework = void 0;
exports.ISO27001Framework = {
    type: 'ISO-27001',
    name: 'ISO/IEC 27001:2022',
    version: '2022',
    description: 'ISO 27001 is an international standard for information security management systems (ISMS) that provides a systematic approach to managing sensitive company information.',
    categories: [
        {
            name: 'Organizational Controls',
            description: 'Controls related to organizational policies, roles, and responsibilities',
            order: 1
        },
        {
    ...
    controls: [
        // Organizational Controls (Clause 5)
        {
            ...
            description: 'Information security policy and topic-specific policies shall be defined, approved by management, published, communicated to relevant personnel and relevant interested parties',
            ...
            implementationGuidance: 'Establish comprehensive information security policy framework with regular review cycles',
            testingProcedures: [
        ...
        },
        {
            ...
            implementationGuidance: 'Define RACI matrix for information security responsibilities',
            testingProcedures: [
        ...
        },
        {
            ...
            implementationGuidance: 'Implement role-based access control with automated conflict detection',
            testingProcedures: [
        ...
        },
        {
            ...
            automationLevel: 'partial',
            implementationGuidance: 'Establish threat intelligence program with automated feeds',
            testingProcedures: [
        ...
        },
        {
            ...
            automationLevel: 'partial',
            implementationGuidance: 'Create acceptable use policy with monitoring and enforcement',
            testingProcedures: [
                'Review use policies',
        ...
        },
        {
            ...
            automationLevel: 'partial',
            implementationGuidance: 'Implement cloud governance framework with security controls',
            testingProcedures: [
        ...
        // People Controls (Clause 6)
        {
            ...
            evidenceTypes: ['document', 'user_attestation', 'system_report'],
            automationLevel: 'manual',
            implementationGuidance: 'Establish background screening program aligned with local laws',
            testingProcedures: [
        ...
        },
        {
            ...
            description: 'Employment contractual agreements shall state the personnel', s, and, organization, 's responsibilities for information security': ,
            categoryId: 'people-controls',
            requirements: [
            ...
            automationLevel: 'manual',
            implementationGuidance: 'Include comprehensive security clauses in employment contracts',
            testingProcedures: [
        ...
        },
        {
            ...
            automationLevel: 'partial',
            implementationGuidance: 'Develop comprehensive security awareness program',
            testingProcedures: [
        ...
        },
        {
            ...
            description: 'A disciplinary process shall be formalized and communicated to take actions when personnel violate information security policies',
            categoryId: 'people-controls',
            requirements: [
            ...
            evidenceTypes: ['document', 'user_attestation', 'system_report'],
            automationLevel: 'manual',
            implementationGuidance: 'Establish fair and consistent disciplinary procedures',
            testingProcedures: [
        ...
        // Physical Controls (Clause 7)
        {
            ...
            description: 'Security perimeters shall be defined and used to protect areas containing information and other associated assets',
            ...
            automationLevel: 'partial',
            implementationGuidance: 'Implement layered physical security with monitoring',
            testingProcedures: [
        ...
        // Technological Controls (Clause 8)
        {
            ...
            automationLevel: 'full',
            implementationGuidance: 'Deploy endpoint detection and response (EDR) solution',
            testingProcedures: [
        ...
        },
        {
            ...
            automationLevel: 'full',
            implementationGuidance: 'Implement privileged access management (PAM) solution',
            testingProcedures: [
        ...
        },
        {
            ...
            evidenceTypes: ['configuration', 'system_report', 'log_data'],
            automationLevel: 'full',
            implementationGuidance: 'Implement DLP with content inspection and blocking',
            testingProcedures: [
                'Test DLP rules',
        ...
        },
        {
            ...
            evidenceTypes: ['configuration', 'system_report', 'log_data'],
            automationLevel: 'full',
            implementationGuidance: 'Deploy secure web gateway with threat intelligence',
            testingProcedures: [
        ...
        },
        {
            ...
            automationLevel: 'partial',
            implementationGuidance: 'Integrate security into SDLC with automated scanning',
            testingProcedures: [
...
//# sourceMappingURL=iso27001.framework.js.map