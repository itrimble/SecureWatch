...
import { LearningPathSchema, LearningModuleSchema, LessonSchema } from '../types/educational.types';
export class LearningManagementService extends EventEmitter {
    ...
    async getLearningPath(pathId, includeModules = true) {
    ...
    async searchLearningPaths(filters, pagination) {
    ...
    async addModuleToPath(pathId, module, order) {
    ...
    // Lesson Management
    async addLessonToModule(moduleId, lesson) {
    ...
    // Statistics
    async getLearningPathStatistics() {
        const [totalPaths, totalModules, totalLessons, skillLevelStats, categoryStats, difficultyStats] = await Promise.all([
...
//# sourceMappingURL=learning-management-service.js.map