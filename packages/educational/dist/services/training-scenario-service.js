...
import { TrainingScenarioSchema } from '../types/educational.types';
export class TrainingScenarioService extends EventEmitter {
    ...
    async getTrainingScenario(scenarioId) {
    ...
    async searchTrainingScenarios(filters, pagination) {
    ...
    async startScenarioInstance(scenarioId, studentId) {
    ...
    async provisionScenarioEnvironment(instance, scenario) {
        try {
    ...
    async getScenarioInstance(instanceId) {
        return this.activeInstances.get(instanceId) || null;
    }
    async getActiveInstanceForStudent(scenarioId, studentId) {
    ...
    async submitObjective(instanceId, objectiveId, submission) {
    ...
    async validateObjectiveSubmission(objective, submission) {
    ...
    async createAttackSimulation(simulationData) {
        const newSimulation = {
            id: uuidv4(),
            createdAt: new Date(),
            ...simulationData
    ...
    async getAttackSimulations(category) {
    ...
    async recordAnalyticsEvent(scenarioId, studentId, instanceId, eventType, eventData) {
...
//# sourceMappingURL=training-scenario-service.js.map