...
import { StudentProgressSchema, EnrollmentSchema } from '../types/educational.types';
export class ProgressTrackingService extends EventEmitter {
    ...
    async enrollStudent(studentId, learningPathId, enrollmentData) {
    ...
    async getStudentProgress(studentId, learningPathId, contentType) {
    ...
    // Achievement System
    async checkStudentAchievements(studentId) {
    ...
    // Helper Methods
    async initializeProgressTracking(studentId, learningPathId) {
    ...
    async updateLearningStreak(studentId) {
    ...
    async getLearningStreak(studentId) {
        return await this.db('learning_streaks').where('student_id', studentId).first();
    }
    async recordLearningSession(studentId, sessionData) {
    ...
    async getRecentSessions(studentId, days) {
    ...
    evaluateAchievementCriteria(criteria, analytics) {
    ...
    getMetricValue(metric, analytics) {
        switch (metric) {
            case 'enrollments':
