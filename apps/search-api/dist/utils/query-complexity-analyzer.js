...
exports.queryRateLimiter = exports.QueryRateLimiter = exports.queryComplexityAnalyzer = exports.QueryComplexityAnalyzer = void 0;
class QueryComplexityAnalyzer {
    ...
    analyzeTimeRange(startTime, endTime) {
        ...
        try {
            ...
            if (diffHours > 24)
                complexityScore += 10; // More than 1 day
            if (diffHours > 168)
                complexityScore += 20; // More than 1 week
        }
        catch (error) {
     ...
     */
    calculateTimeRangeHours(startTime, endTime) {
    ...
    estimateResourceUsage(params) {
        ...
        if (params.complexityScore > 50)
            cpuLevel = 'High';
        else if (params.complexityScore > 25)
            cpuLevel = 'Medium';
...
exports.queryComplexityAnalyzer = new QueryComplexityAnalyzer();
class QueryRateLimiter {
    constructor(config) {
        this.config = config;
        this.queryCache = new Map();
        this.complexQueryCache = new Map();
    }
    /**
     * Check if user can execute query based on rate limits
     */
    canExecuteQuery(userId, complexityScore) {
        const now = Date.now();
...
exports.QueryRateLimiter = QueryRateLimiter;
// Default rate limiter instance
exports.queryRateLimiter = new QueryRateLimiter({
