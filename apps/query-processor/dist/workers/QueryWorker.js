...
export class QueryWorker {
    ...
    currentJobs = new Set();
    maxConcurrentJobs;
    constructor(jobQueue, queryExecutor, wsService, maxConcurrentJobs = 5) {
    ...
    async processJob(bullJob) {
        ...
        try {
            ...
            await this.jobQueue.updateJobStatus(jobId, 'completed', undefined, resultLocation, resultSize);
            // Send WebSocket notification
            this.wsService.notifyJobComplete(jobId, job.user_id, job.organization_id, {
                ...result,
...
if (require.main === module) {
    async function startWorker() {
        try {
            ...
            const wsService = new WebSocketService(parseInt(process.env.WS_PORT || '8080', 10));
