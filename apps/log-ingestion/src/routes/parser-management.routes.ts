...
export class ParserManagementRoutes {
  ...
  private processor: EnhancedLogProcessor;
  ...
  // List all available parsers
  private async listParsers(req: any, res: any): Promise<void> {
    try {
  ...
  // Get parser statistics
  private async getParserStats(req: any, res: any): Promise<void> {
    try {
  ...
  private async getParserMetrics(req: any, res: any): Promise<void> {
    try {
  ...
  private async getParser(req: any, res: any): Promise<void> {
    try {
      const { parserId } = req.params;
  ...
  // Enable/disable parser
  private async toggleParser(req: any, res: any): Promise<void> {
    try {
      const { parserId } = req.params;
  ...
  // Test parser with sample data
  private async testParser(req: any, res: any): Promise<void> {
    try {
      const { parserId } = req.params;
  ...
  private async validateParser(req: any, res: any): Promise<void> {
    try {
      const { parserId } = req.params;
  ...
  // Parse single log with specific parser
  private async parseWithParser(req: any, res: any): Promise<void> {
    try {
      const { parserId } = req.params;
  ...
  // Get parsers by category
  private async getParsersByCategory(req: any, res: any): Promise<void> {
    try {
  ...
  // Get parsers by source
  private async getParsersBySource(req: any, res: any): Promise<void> {
    try {
  ...
  // Reset parser metrics
  private async resetParserMetrics(req: any, res: any): Promise<void> {
    try {
      const { parserId } = req.params;
  ...
  // Get top performing parsers
  private async getTopPerformers(req: any, res: any): Promise<void> {
    try {
      ...
      res.json({
        status: 'success',
        topPerformers: stats.topPerformers.slice(0, parseInt(limit as string, 10))
      });
