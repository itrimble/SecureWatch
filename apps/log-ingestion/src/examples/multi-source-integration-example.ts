...
async function demonstrateWindowsEventLogs(service: IntegrationService) {
  console.log('📊 Configuring Windows Event Log Sources...');

  const windowsConfigs: DataSourceConfig[] = [
    {
      id: 'windows-dc01',
...
async function demonstrateSyslogSources(service: IntegrationService) {
  console.log('📡 Configuring Syslog Sources...');

  const syslogConfigs: DataSourceConfig[] = [
    {
      id: 'syslog-udp-514',
...
async function demonstrateCloudPlatforms(service: IntegrationService) {
  console.log('☁️ Configuring Cloud Platform Sources...');

  const cloudConfigs: DataSourceConfig[] = [
    {
      id: 'aws-cloudtrail',
      name: 'AWS CloudTrail',
      type: 'cloud_trail',
...
async function demonstrateNetworkSecurity(service: IntegrationService) {
  console.log('🛡️ Configuring Network Security Sources...');

  const networkConfigs: DataSourceConfig[] = [
    {
      id: 'palo-alto-fw01',
...
async function showServiceStatistics(service: IntegrationService) {
...
async function demonstrateHealthMonitoring(service: IntegrationService) {
...
function setupEventListeners(service: IntegrationService) {
