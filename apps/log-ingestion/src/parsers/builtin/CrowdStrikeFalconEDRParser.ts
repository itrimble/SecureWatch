// apps/log-ingestion/src/parsers/builtin/CrowdStrikeFalconEDRParser.ts
 ...
 */
export class CrowdStrikeFalconEDRParser implements LogParser {
  ...
  private mapSeverity(level: string): 'low' | 'medium' | 'high' | 'critical' {
    ...
    if (severity === 'medium' || severity === 'informational') return 'medium';
    return 'low';
  }
