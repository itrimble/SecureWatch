...
export class FieldMapper {
  private profiles: Map<string, FieldMappingProfile> = new Map();
  private transformationHandlers: Map<TransformationType, (value: any, params?: any) => any> = new Map();
   ...
   */
  async mapToLogEvent(rawData: Record<string, any>, profileId: string, sourceInfo: any): Promise<LogEvent> {
   ...
   */
  private applyMappings(rawData: Record<string, any>, mappings: MappingRule[]): Record<string, any> {
   ...
   */
  private validateData(data: Record<string, any>, validations: ValidationRule[]): Record<string, any> {
   ...
   */
  private createLogEvent(data: Record<string, any>, sourceInfo: any): LogEvent {
    return {
  ...
  private registerDefaultTransformations(): void {
    this.transformationHandlers.set('uppercase', (value) => 
      typeof value === 'string' ? value.toUpperCase() : value
    );

    this.transformationHandlers.set('lowercase', (value) => 
      typeof value === 'string' ? value.toLowerCase() : value
    );

    this.transformationHandlers.set('trim', (value) => 
   ...
   */
  private parseCustomDate(dateString: string, format: string): Date {
  ...
  createProfile(
    ...
    const profile: FieldMappingProfile = {
      ...
      mappings: mappings.map(mapping => ({
        ...
        transformation: mapping.transformation as TransformationType,
