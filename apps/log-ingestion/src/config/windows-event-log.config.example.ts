...
export const highPerformanceConfig: WindowsEventLogConfig = {
  channels: [
    'Security',
    'System', 
    'Application',
...
export const domainControllerConfig: WindowsEventLogConfig = {
...
export const forensicAnalysisConfig: WindowsEventLogConfig = {
...
export const endpointMonitoringConfig: WindowsEventLogConfig = {
...
export const developmentConfig: WindowsEventLogConfig = {
...
export const wefCollectorConfig: WindowsEventLogConfig = {
...
export function getConfigForEnvironment(environment: string): WindowsEventLogConfig {
...
export function validateConfig(config: WindowsEventLogConfig): string[] {
  const errors: string[] = [];
