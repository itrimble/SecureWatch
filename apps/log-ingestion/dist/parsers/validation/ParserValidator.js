...
export class ParserValidator {
    ...
    async testParser(parser, testCases) {
        const results = [];
    ...
    validateRequiredFields(parser, errors) {
    ...
    async validateParserMethods(parser, errors, warnings) {
    ...
    validateParserConfig(parser, warnings) {
        if (parser.config) {
    ...
    async runBasicTests(parser, errors, warnings) {
