...
export class ApacheAccessLogParser {
    ...
    normalize(event) {
        const statusCode = event.custom?.status_code;
        const method = event.custom?.method;
        const normalized = {
    ...
    getOutcomeFromStatus(statusCode) {
    ...
    mapToECSType(method, statusCode) {
        if (statusCode >= 400) {
            return ['denied'];
        }
    ...
    getTagsForEvent(statusCode, method, threat) {
...
//# sourceMappingURL=ApacheAccessLogParser.js.map