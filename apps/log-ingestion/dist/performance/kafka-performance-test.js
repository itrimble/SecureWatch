...
export class KafkaPerformanceTester {
    ...
    async runProducerTest(targetMessagesPerSecond = 10_000_000, durationSeconds = 60) {
    ...
    async runConsumerTest(durationSeconds = 60) {
...
//# sourceMappingURL=kafka-performance-test.js.map