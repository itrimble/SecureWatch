...
export class CloudTrailSource extends DataSource {
    ...
    generateAwsRequestParameters(eventName) {
        const paramMap = {
    ...
    generateAwsResponseElements(eventName) {
        const responseMap = {
    ...
    generateAzureRequestParameters(operationName) {
    ...
    generateGcpRequestParameters(methodName) {
        return {
    ...
    getAwsResourceType(eventSource) {
        const typeMap = {
    ...
    generateAzureResourceId(operationName) {
    ...
    generateGcpResourceName(methodName) {
    ...
    mapCloudEventCategory(eventName) {
    ...
    generateCloudEventMessage(event) {
...
//# sourceMappingURL=cloud-trail-source.js.map