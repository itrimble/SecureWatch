...
export class PatternMatcher {
    ...
    async findMatches(event, eventBuffer) {
        const matches = [];
        try {
    ...
    async checkBruteForcePattern(event, eventBuffer) {
    ...
    async checkPrivilegeEscalationPattern(event, eventBuffer) {
    ...
    async checkLateralMovementPattern(event, eventBuffer) {
    ...
    async checkDataExfiltrationPattern(event, eventBuffer) {
