...
export class QueryLibrary {
    ...
    searchQueries(searchTerm) {
        ...
        return this.getAllQueries().filter(query => query.name.toLowerCase().includes(term) ||
...
//# sourceMappingURL=query-library.js.map