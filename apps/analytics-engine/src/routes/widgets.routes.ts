...
export class WidgetRoutes {
  ...
  private async getTotalEvents(req: express.Request, res: express.Response): Promise<void> {
  ...
  private async getActiveSources(req: express.Request, res: express.Response): Promise<void> {
  ...
  private async getSecurityIncidents(req: express.Request, res: express.Response): Promise<void> {
  ...
  private async getNetworkActivity(req: express.Request, res: express.Response): Promise<void> {
  ...
  private async getEventsTimeline(req: express.Request, res: express.Response): Promise<void> {
  ...
  private async getTopSources(req: express.Request, res: express.Response): Promise<void> {
  ...
  private async getSystemPerformance(req: express.Request, res: express.Response): Promise<void> {
  ...
  private async getRecentAlerts(req: express.Request, res: express.Response): Promise<void> {
