...
export default function KQLAnalyticsPage() {
  ...
  const [libraryStats, setLibraryStats] = useState<QueryLibraryStats | null>(
    null
  );
  ...
  const validateQuery = async () => {
    ...
    try {
      ...
      if (data.valid) {
        ...
        setQueryError(
          `Validation errors: ${data.errors.map((e: any) => e.message).join(', ')}`
        );
      }
    } catch (error) {
  ...
  const categories = [
    'all',
    ...Object.keys(libraryStats?.queriesByCategory || {}),
  ];
  const severityLevels = [
    'all',
    ...Object.keys(libraryStats?.queriesBySeverity || {}),
  ];
        ...
        <div className="flex items-center justify-between p-6">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Advanced analytics with Microsoft Sentinel-compatible KQL queries
              for threat hunting and security analysis
            </p>
          </div>
            ...
            <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-6 p-6 overflow-hidden">
              ...
              <Card className="flex flex-col">
                <CardHeader>
                  ...
                  <CardDescription>
                    Write KQL queries to analyze security data. Supports
                    Microsoft Sentinel syntax.
                  </CardDescription>
                </CardHeader>
...
| order by FailureCount desc`}
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        console.log(
                          'Save query functionality to be implemented'
                        )
                      }
                    >
          ...
          <TabsContent value="library" className="flex-1 overflow-hidden">
            <div className="h-full flex flex-col p-6">
              ...
              <Card className="mb-6">
                <CardHeader>
                  <CardTitle>
                    Query Library - Security Analytics Templates
                  </CardTitle>
                  <CardDescription>
                    Pre-built KQL queries for common security use cases and
                    threat hunting
                  </CardDescription>
                </CardHeader>
                <CardContent>
