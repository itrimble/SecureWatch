...
import { Settings, Clock, Users, Shield, Bell, Database, Zap, RefreshCw, Calendar, AlertTriangle, CheckCircle, Mail, Webhook, FileText, Pause, Play, Edit, Copy, Trash2, Download, Upload, Filter, Search } from 'lucide-react'
...
export function AlertConfigurationManager() {
    ...
    const sampleConfigs: AlertConfiguration[] = [
      {
        ...
        description: 'Advanced brute force attack detection with adaptive thresholds',
  ...
  const ConfigurationCard = ({ config }: { config: AlertConfiguration }) => (
    <Card className="mb-4 hover:shadow-md transition-shadow cursor-pointer" onClick={() => setSelectedConfig(config)}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
          <div>
            ...
            <div className="flex items-center space-x-1 mt-1">
              ...
              <span className="capitalize">{config.schedule.type}</span>
            </div>
          </div>
          <div>
            ...
            <div className="flex items-center space-x-1 mt-1">
              ...
              <span>{config.triggerCount} times</span>
            </div>
          </div>
          <div>
            <span className="font-medium text-gray-500">Suppression:</span>
            <div className="mt-1">
              <Badge variant={config.suppression.enabled ? 'default' : 'outline'} className="text-xs">
                {config.suppression.enabled ? 'Active' : 'Disabled'}
              </Badge>
            </div>
          </div>
          <div>
            <span className="font-medium text-gray-500">Escalation:</span>
            <div className="mt-1">
              <Badge variant={config.escalation.enabled ? 'default' : 'outline'} className="text-xs">
                {config.escalation.enabled ? `${config.escalation.levels.length} levels` : 'Disabled'}
              </Badge>
            </div>
          </div>
        </div>
        ...
        <CardContent className="p-4">
          <div className="flex items-center space-x-2">
            ...
            <div>
              ...
              <p className="text-2xl font-bold">{configurations.filter(c => c.enabled).length}</p>
            </div>
          </div>
        </CardContent>
      </Card>
      <Card>
        <CardContent className="p-4">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <p className="text-sm font-medium text-gray-500">With Escalation</p>
              <p className="text-2xl font-bold">{configurations.filter(c => c.escalation.enabled).length}</p>
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="p-4">
          <div className="flex items-center space-x-2">
            ...
            <div>
              ...
              <p className="text-2xl font-bold">{configurations.filter(c => c.suppression.enabled).length}</p>
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="p-4">
          <div className="flex items-center space-x-2">
            ...
            <div>
              ...
              <p className="text-2xl font-bold">{configurations.filter(c => c.schedule.type === 'realtime').length}</p>
            </div>
          </div>
        </CardContent>
      </Card>
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Configure multi-level escalation for critical alerts</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-center justify-between">
                  ...
                  <Card key={level} className="p-4">
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      <div>
                        ...
                        <Input type="number" defaultValue={level === 1 ? "5" : level === 2 ? "15" : "30"} />
                      </div>
                      <div>
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Reduce alert noise with intelligent suppression</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-center justify-between">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label htmlFor="suppression-duration">Suppression Duration (seconds)</Label>
                <Input id="suppression-duration" type="number" defaultValue="300" />
              </div>
              <div>
            ...
            <div>
              ...
              <Input id="suppression-fields" placeholder="source_ip, username, event_id" />
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <Label htmlFor="suppress-duplicates">Suppress Duplicate Alerts</Label>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input id="correlation-key" placeholder="e.g., attack_campaign, incident_type" />
              </div>
              <div>
                <Label htmlFor="correlation-window">Time Window (seconds)</Label>
                <Input id="correlation-window" type="number" defaultValue="900" />
              </div>
            </div>
            <div>
              ...
              <div className="mt-2 space-y-2">
                <div className="flex items-center justify-between p-2 border rounded">
                  <span className="text-sm">Group by source IP and attack type</span>
                  <Switch defaultChecked />
                </div>
                <div className="flex items-center justify-between p-2 border rounded">
                  <span className="text-sm">Correlate failed logins with privilege escalation</span>
                  <Switch defaultChecked />
                </div>
                <div className="flex items-center justify-between p-2 border rounded">
                  <span className="text-sm">Link network anomalies with endpoint alerts</span>
                  <Switch />
                </div>
              </div>
            </div>
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>System-wide alert configuration settings</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-center justify-between">
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <Input placeholder="Timeout (seconds)" type="number" defaultValue="30" />
                <Input placeholder="Retry Attempts" type="number" defaultValue="3" />
              </div>
            </div>
          </div>
        </CardContent>
    ...
    <div className="p-6 max-w-7xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">Advanced alert management and configuration</p>
        </div>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Badge variant={selectedConfig.enabled ? 'default' : 'secondary'} className="mt-1">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-sm mt-1 capitalize">{selectedConfig.schedule.type}</p>
                </div>
                <div>
                  <Label className="text-sm font-medium text-gray-500">Time Window</Label>
                  <p className="text-sm mt-1">{selectedConfig.schedule.timeWindow}</p>
                </div>
              </div>

              {selectedConfig.suppression.enabled && (
                <div>
                  <Label className="text-sm font-medium text-gray-500">Suppression Settings</Label>
                  <div className="mt-2 p-3 bg-gray-50 rounded border">
                    <div className="grid grid-cols-3 gap-3 text-sm">
                      <div>
                        <span className="font-medium">Duration:</span> {selectedConfig.suppression.duration}s
                      </div>
                      <div>
                        <span className="font-medium">Max Alerts:</span> {selectedConfig.suppression.maxAlerts}
                      </div>
                      <div>
                        <span className="font-medium">Fields:</span> {selectedConfig.suppression.fields.join(', ')}
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {selectedConfig.escalation.enabled && (
                <div>
                  <Label className="text-sm font-medium text-gray-500">Escalation Levels</Label>
                  <div className="mt-2 space-y-2">
                    {selectedConfig.escalation.levels.map(level => (
                      <div key={level.id} className="p-3 border rounded">
                        ...
                        <p className="text-sm text-gray-600 mt-1">
                          Triggers after {level.delayMinutes} minutes with {level.actions.length} action(s)
                        </p>
                      </div>
                    ))}
                  </div>
